...
// Data - структура, реализующая контракт кэширующего модуля
type Data struct {
	indexFile, storageFile string
}

// New - конструктор.
func New(cacheFiles map[string]string) *Data {
	c := Data{
...
func (c *Data) Create(index *index.Interface, storage *storage.Interface) error {
...
func (c *Data) Load() (*index.Interface, *storage.Interface, error) {
