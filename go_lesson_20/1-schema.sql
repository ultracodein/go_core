...
CREATE INDEX IF NOT EXISTS actors_full_name_idx ON actors USING btree (lower(full_name));
...
CREATE INDEX IF NOT EXISTS directors_full_name_idx ON directors USING btree (lower(full_name));
